                            ...
                            if (data.hash[event.params.key]) {
                                ...
                                if (api_path.indexOf('@') > -1) {
                                    if (api_path.indexOf("node::") == -1) {
                                        ...
                                        var modulePath = api_path;
                                        global.lv_api_caching[event.params.key].isNodejsModule = true;
                                ...
                                logs.debug({ message: "api was not found" });
...
const compiler = require("./../libs/lv.compile");
/**
 * Gọi 1 api 
 * @param {any} event
 */

    ...
    if (typeof expr === "string") {
        ...
        if (expr.fn) {
            if (!expr.fn.name) {
                ...
                return cFn.resolve(p.args, params);
            }
        }
        if (expr.content) {
...
setConnectionString("mongodb://172.16.0.126:2324/candidate");



//console.log(x.getSchema())
//entity("ls_requisition")
//    .where("contains(Locations.Provinces.Name.vn,txt)", {txt:"Hồ"})

//    .toItem((err, result) => {
//        console.log(err);
//        console.log(result);
//    })
//entity("sys_Users").where("(IsActive==IsActive)")
//    .toItem((err, result) => {
//        console.log(err);
//        console.log(result);
//    })
...
//setTrashCollectionName("ls_deleted_entities");
//var trash = entity("ls_deleted_entities");
//trash
//    .where("_id", "5a0265b3aeefd7251ce9b51a".toObjectID())
//    .toArray((err, list) => {
//        console.log(list);
//    })


//var test = entity("ls_test");
//test
//    .where("CreatedBy", "application")
//    .delete()
//    .commit((err, result) => {
//        console.log(err);
//        console.log(result);
...
////// use the function
//var x = MATHJS.parse('(contains(xxxx,name))');
//console.log(x);